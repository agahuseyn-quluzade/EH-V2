...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<ErrorResponse>> handleAccessDeniedException(AccessDeniedException ex) {
        return buildResponse(PolicyErrorEnum.FORBIDDEN.getHttpStatus(), PolicyErrorEnum.FORBIDDEN.getMessage(),
                Map.of("errorCode", PolicyErrorEnum.FORBIDDEN.getErrorCode()));
    }
