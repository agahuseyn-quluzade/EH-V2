...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<ErrorResponse>> handleAccessDeniedException(AccessDeniedException ex) {
        return buildResponse(NotificationErrorEnum.FORBIDDEN.getHttpStatus(), NotificationErrorEnum.FORBIDDEN.getMessage(),
                Map.of("errorCode", NotificationErrorEnum.FORBIDDEN.getErrorCode()));
    }
