...
export default function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/staff/queue" element={<Protected roles={["STAFF"]}><StaffQueuePage /></Protected>} />
      <Route path="/staff/claims/:id" element={<Protected roles={["STAFF"]}><StaffClaimReviewPage /></Protected>} />
