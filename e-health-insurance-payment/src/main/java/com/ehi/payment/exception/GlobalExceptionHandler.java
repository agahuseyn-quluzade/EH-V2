...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<ErrorResponse>> handleAccessDeniedException(AccessDeniedException ex) {
        return buildResponse(PaymentErrorEnum.FORBIDDEN.getHttpStatus(), PaymentErrorEnum.FORBIDDEN.getMessage(),
                Map.of("errorCode", PaymentErrorEnum.FORBIDDEN.getErrorCode()));
    }
